package com.timvisee.glowstonelanterns.manager;
...
public class GLPermissionsManager {
	 ...
	 */
	public GLPermissionsManager(Server s, Plugin p, Logger log) {
		this.s = s;
		this.p = p;
		this.log = log;
	}
	...
	public PermissionsSystemType setup() {
		...
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.PermissionsEx.enabled", true)) {
		...
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.PermissionsBukkit.enabled", true)) {
		...
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.bPermissions.enabled", true)) {
		...
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.EssentialsGroupManager.enabled", true)) {
		...
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.zPermissions.enabled", true)) {
		...
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.Vault.enabled", true)) {
		...
		// Permissions
		// Check if Vault is allowed to be used
		if(GlowstoneLanterns.instance.getConfig().getBoolean("permissions.permissionsSystems.Permissions.enabled", true)) {
